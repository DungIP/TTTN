      ...
      <div class="container-fluid">
             ...
             <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tables Purchase History</h3>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
                    <script>
                      $(document).ready(function(){
                        ...
                        $.post("api/getCount.asp",{table: "purchase_history", limit: 3},
                      ...
                      function loadTable(page){
                        ...
                        $.post("api/purchase_history_list.asp",{page: page},
                          function(data,status){
                      ...
                      function populateTable(data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                          ...
                          row.insertCell(2).innerHTML = data[i].account_game_id;
                          row.insertCell(3).innerHTML = data[i].transaction_time;
