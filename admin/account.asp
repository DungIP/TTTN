    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
                    <script>
                      $(document).ready(function(){
                        ...
                        $("#last").click(function(){
                          loadTable(0);
                          setPage_active(parseInt(localStorage.getItem('last_page_account'))-1);
                        });
                        ...
                        $("#Next").click(function(){
                          loadTable($('#Next').text());
                          if ($('#Next').text()!==localStorage.getItem('last_page_account')) {
                        ...
                        $.post("api/getCount.asp",{table: "account", limit: 3},
                          function(data,status){
                            localStorage.setItem('last_page_account', data);
                      ...
                      function loadTable(page){
                        ...
                        $.post("api/account_list.asp",{page: page},
                          function(data,status){
                      ...
                      function populateTable(data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                          ...
                          row.insertCell(1).innerHTML = data[i].role_account;
                          row.insertCell(2).innerHTML = data[i].user_name;
                          row.insertCell(3).innerHTML = data[i].email;
                          row.insertCell(4).innerHTML = new Intl.NumberFormat().format(data[i].account_balance);
                        }
                      }
                      </script>
 </body>
